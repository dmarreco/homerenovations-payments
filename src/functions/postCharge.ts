...
async function postChargeHandler(event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> {
...
export const handler = withMiddyHttp(postChargeHandler, 'postCharge');
